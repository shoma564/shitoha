...
var _chunk2BY3EOMXjs = require('./chunk-2BY3EOMX.js');
...
async function load(filepath, themeMeta, content) {
  ...
  const data = await _chunk2BY3EOMXjs.parse.call(void 0, markdown, filepath, themeMeta, [], async (headmatter, exts, filepath2) => {
  ...
  for (let iSlide = 0; iSlide < data.slides.length; ) {
    ...
    const subSlides = await _chunk2BY3EOMXjs.parse.call(void 0, raw, path, themeMeta, preparserExtensions);
    for (const [offset, subSlide] of subSlides.slides.entries()) {
      ...
      data.features = _chunk2BY3EOMXjs.mergeFeatureFlags.call(void 0, data.features, _chunk2BY3EOMXjs.detectFeatures.call(void 0, raw));
      entries.add(path);
...
async function save(data, filepath) {
  ...
  await _fs.promises.writeFile(filepath, _chunk2BY3EOMXjs.stringify.call(void 0, data), "utf-8");
}
async function saveExternalSlide(slide) {
  await _fs.promises.writeFile(slide.filepath, _chunk2BY3EOMXjs.stringifySlide.call(void 0, slide), "utf-8");
}
...
exports.detectFeatures = _chunk2BY3EOMXjs.detectFeatures; exports.filterDisabled = _chunk2BY3EOMXjs.filterDisabled; exports.getDefaultConfig = _chunk2BY3EOMXjs.getDefaultConfig; exports.injectPreparserExtensionLoader = injectPreparserExtensionLoader; exports.load = load; exports.mergeFeatureFlags = _chunk2BY3EOMXjs.mergeFeatureFlags; exports.parse = _chunk2BY3EOMXjs.parse; exports.parseAspectRatio = _chunk2BY3EOMXjs.parseAspectRatio; exports.parseRangeString = _chunk2BY3EOMXjs.parseRangeString; exports.parseSlide = _chunk2BY3EOMXjs.parseSlide; exports.prettify = _chunk2BY3EOMXjs.prettify; exports.prettifySlide = _chunk2BY3EOMXjs.prettifySlide; exports.resolveConfig = _chunk2BY3EOMXjs.resolveConfig; exports.resolveFonts = _chunk2BY3EOMXjs.resolveFonts; exports.save = save; exports.saveExternalSlide = saveExternalSlide; exports.scanMonacoModules = _chunk2BY3EOMXjs.scanMonacoModules; exports.stringify = _chunk2BY3EOMXjs.stringify; exports.stringifySlide = _chunk2BY3EOMXjs.stringifySlide; exports.verifyConfig = _chunk2BY3EOMXjs.verifyConfig;
